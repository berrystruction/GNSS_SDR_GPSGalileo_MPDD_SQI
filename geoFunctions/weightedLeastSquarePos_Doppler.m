function [pos_fin, el, az, dop, RAIMresult,wdop] = weightedLeastSquarePos_Doppler(satpos, obs,channels,doppler, settings,cov_noise)
...
for iter = 1:nmbOfIterations
    ...
    x   = (A'*inv_cov_noise*A)^(-1)*A'*inv_cov_noise*omc;
