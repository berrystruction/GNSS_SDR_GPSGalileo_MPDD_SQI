...
numberOfFrqBins = round((settings.acqSearchBand*1e3)/settings.acqSearchStep)+1;%round(settings.acqSearchBand * 2) + 1;
...
%% Correlate signals ======================================================   
    ...
    for frqBinIndex = 1:numberOfFrqBins
        ...
        % (ho modificato lo step di 500 Hz, ora è variabile)
        frqBins(frqBinIndex) = settings.IF - ...
                               (settings.acqSearchBand/2) * 1000 + ...
                               settings.acqSearchStep * (frqBinIndex - 1); %0.5e3 * (frqBinIndex - 1);

        %--- Generate local sine and cosine -------------------------------
        sinCarr = sin(frqBins(frqBinIndex) * phasePoints);
        cosCarr = cos(frqBins(frqBinIndex) * phasePoints);

        expCarr = sinCarr +1i*cosCarr;
...
%% Fine resolution frequency search =======================================
        ...
        %--- Find the next highest power of two and increase by 16x --------
        ...
        acqResults.codePhase(PRN) = codePhase+settings.skipNumberOfBytes;
