function [covarianceMTX, covariancePosVelocityMTX, cumulativepseudo]  = covNoiseMakerEl(trackres,currMeasNr,lenChList,pseudoNew,pseudocumul,SQI,SQIthreshold,SQIpenalty,el)
%COVNOISEMAKER
...
% MARUCCO MODEL
sigma2_i=1./(cos(pi/2-el*pi/180).^2+.3*sin(pi/2-el*pi/180).^2);
